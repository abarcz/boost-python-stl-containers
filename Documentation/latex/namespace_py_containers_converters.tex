...
\index{PyContainersConverters@{PyContainersConverters}!pyListToSet@{pyListToSet}}
\index{pyListToSet@{pyListToSet}!PyContainersConverters@{PyContainersConverters}}
\subsubsection[{pyListToSet}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ std::set$<$ T $>$ PyContainersConverters::pyListToSet (boost::python::list {\em pyList})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
